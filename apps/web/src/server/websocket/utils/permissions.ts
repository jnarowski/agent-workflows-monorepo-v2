...
export async function validateSessionAccess(
  ...
  try {
    ...
    if (!session) {
      console.log(
        `[Permissions] Session ${sessionId} not found`
      );
      return false;
    }
    ...
    if (!hasAccess) {
      console.log(
        `[Permissions] Access denied: User ${userId} does not own session ${sessionId}`
      );
    }
    ...
    console.error(
      `[Permissions] Error validating session access:`,
      error
    );
    return false;
  }
...
export async function validateProjectAccess(
  ...
  try {
    ...
    if (!project) {
      console.log(
        `[Permissions] Project ${projectId} not found`
      );
      return false;
    }
    ...
    console.error(
      `[Permissions] Error validating project access:`,
      error
    );
    return false;
  }
