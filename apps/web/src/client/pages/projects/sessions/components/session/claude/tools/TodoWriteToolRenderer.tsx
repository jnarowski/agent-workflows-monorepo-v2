      ...
      {input.todos.map((todo, index) => {
        ...
        return (
          <div key={index} className="flex items-start gap-2">
            {/* Checkbox */}
            <div className={`h-4 w-4 mt-0.5 flex-shrink-0 rounded border-2 flex items-center justify-center ${
              isCompleted
              ...
              {isInProgress && <Circle className="h-2 w-2 fill-blue-600 dark:fill-blue-400 text-blue-600 dark:text-blue-400" />}
            </div>
