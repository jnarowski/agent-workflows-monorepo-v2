...
export function TextBlock({ text, className = "" }: TextBlockProps) {
  ...
  return (
    <div className={`flex gap-2.5 ${className}`}>
      ...
      {/* Text content */}
      <div className="prose prose-sm dark:prose-invert max-w-none prose-hr:my-2 prose-p:my-2 prose-ul:my-2 prose-ol:my-2 prose-li:my-0.5 prose-headings:mb-2 prose-headings:mt-3 prose-p:first:mt-0 prose-p:last:mb-0 prose-pre:my-0 prose-pre:bg-transparent prose-pre:p-0 flex-1 min-w-0 overflow-hidden break-words"
    >
      <ReactMarkdown
