...
const ClaudeIcon = ({ className }: { className?: string }) => (
  <svg
    ...
    className={className}
  >
    {/* Claude icon - stylized 'C' shape */}
    <path d="M16 21.5C12 23 8 22 5.5 18.5C3 15 3 10 5.5 6.5C8 3 12 2 16 3.5" />
    <path d="M16 3.5C18 4 20 6 20.5 8.5C21 11 20.5 13.5 19 15.5" />
  </svg>
);
...
const GeminiIcon = ({ className }: { className?: string }) => (
  <svg
    ...
    className={className}
  >
    {/* Google Gemini icon - star-like pattern */}
...
const CursorIcon = ({ className }: { className?: string }) => (
  <svg
    ...
    className={className}
  >
    {/* Cursor icon - stylized arrow pointer */}
    <path d="M4 2L4 20L8 16L12 22L14 21L10 15L16 15L4 2Z" />
  </svg>
);
